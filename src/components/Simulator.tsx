          ...
          <fieldset>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-6 gap-3">
              {(Object.keys(modalityConfig) as Modality[]).map(m => (
                <button key={m} type="button" onClick={() => handleModalityChange(m)} className={`w-full px-4 py-3 text-sm font-semibold rounded-full transition-all duration-200 ${modality === m ? 'bg-[#C86236] text-white shadow-lg' : 'bg-gray-200 text-gray-800 hover:bg-gray-300'}`}>
